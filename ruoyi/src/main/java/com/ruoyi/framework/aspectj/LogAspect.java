...
@Aspect @Component public class LogAspect {
	 ...
	 * 配置织入点
	 */
	@Pointcut("@annotation(com.ruoyi.framework.aspectj.lang.annotation.Log)") public void logPointCut() {
	 ...
	 * @param joinPoint 切点
	 */
	@AfterReturning(pointcut = "logPointCut()", returning = "jsonResult") public void doAfterReturning(
			JoinPoint joinPoint, Object jsonResult) {
	 ...
	 * @param e         异常
	 */
	@AfterThrowing(value = "logPointCut()", throwing = "e") public void doAfterThrowing(
	...
	private void setRequestValue(JoinPoint joinPoint, SysOperLog operLog) throws Exception {
		...
		if (HttpMethod.PUT.name().equals(requestMethod) || HttpMethod.POST.name()
